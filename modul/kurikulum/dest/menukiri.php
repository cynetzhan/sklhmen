...
<div id="sidebar" class="sidebar responsive">
	...
	<ul class="nav nav-list">
		...
		<li class="<?php echo $status3; ?>">
			<a href="index.php?content=mapel">
				<i class="menu-icon fa fa-users"></i>
		...
		<li class="<?php echo $status4; ?>">
			<a href="index.php?content=pengajar">
				<i class="menu-icon fa fa-users"></i>
				<span class="menu-text"> Kelola Pengajar </span>
			</a>
			<b class="arrow"></b>
		</li>
		...
		<li class="<?php echo $status6; ?>">
			<a href="index.php?content=rapor">
				<i class="menu-icon fa fa-users"></i>
				<span class="menu-text"> Kelola Rapor Siswa </span>
			</a>
			<b class="arrow"></b>
		</li>
		<li class="<?php echo $status7; ?>">
			<a href="index.php?content=prodi">
				<i class="menu-icon fa fa-users"></i>
				<span class="menu-text"> Kelola Program Studi </span>
			</a>
			<b class="arrow"></b>
		</li>
		<li class="<?php echo $status8; ?>">
			<a href="index.php?content=reportrapor">
				<i class="menu-icon fa fa-users"></i>
				<span class="menu-text"> Laporan Rapor Siswa </span>
			</a>
			<b class="arrow"></b>
		</li>
					
		<li class="<?php echo $status9; ?>">
			<a href="index.php?content=reportabsen">
				<i class="menu-icon fa fa-users"></i>
				<span class="menu-text"> Laporan Absen Siswa </span>
			</a>
			<b class="arrow"></b>
		</li>
